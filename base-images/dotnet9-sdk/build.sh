...
DOTNET_FILE="dotnet-sdk-9.0.100-rc.2.24474.11-linux-x64.tar.gz"
DOTNET_DIR="dotnet-sdk-9.0.100-rc.2.24474.11-linux-x64"
DOTNET_OUTPUT="dotnet.tgz"
IMAGE_NAME="registry.cn-shanghai.aliyuncs.com/odboy/kenaito-cicd:runtime-dotnet9-sdk"
# 下载太慢了，手动下载吧兄弟们
DOTNET_URL="https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.100-rc.2.24474.11/dotnet-sdk-9.0.100-rc.2.24474.11-linux-x64.tar.gz"
