...
DOTNET_FILE="dotnet-sdk-8.0.403-linux-x64.tar.gz"
DOTNET_DIR="dotnet-sdk-8.0.403-linux-x64"
DOTNET_OUTPUT="dotnet.tgz"
IMAGE_NAME="registry.cn-shanghai.aliyuncs.com/odboy/kenaito-cicd:runtime-dotnet8-sdk"
# 下载太慢了，手动下载吧兄弟们
DOTNET_URL="https://builds.dotnet.microsoft.com/dotnet/Sdk/8.0.403/dotnet-sdk-8.0.403-linux-x64.tar.gz"
